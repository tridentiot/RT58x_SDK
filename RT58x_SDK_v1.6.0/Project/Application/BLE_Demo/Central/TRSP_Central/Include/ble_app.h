...
typedef enum
{
    ...
    APP_REQUEST_SCAN_START,         /**< Application request event: scanning start.*/
    APP_REQUEST_SCAN_STOP,          /**< Application request event: scanning stop.*/
    ...
    APP_REQUEST_TRSPC_DATA_SEND,    /**< Application request event: TRSP client data send.*/
} app_request_t;
