...
/*
 *enable this option only when there are multiple spi devices connected with SPI0 controller.
 *If there is only one spi device connect with SPI0 controller, you can disable this option safely.
 */
