...
enum zb_zcl_scene_attr_e
{
    ...
    */
    ...
    ZB_ZCL_ATTR_SCENES_CLUSTER_REVISION = 0xFFFD
};
...
#define ZB_ZCL_DECLARE_SCENES_ATTRIB_LIST_TJ(                                    \
    attr_list,                                                                \
    scene_count,                                                              \
    current_scene,                                                            \
    current_group,                                                            \
  ...
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_SCENES_SCENE_VALID_ID, (scene_valid))      \
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_SCENES_NAME_SUPPORT_ID, (name_support))    \
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_SCENES_CLUSTER_REVISION, (cluster_revision)) \
  ZB_ZCL_FINISH_DECLARE_ATTRIB_LIST
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_SCENES_CLUSTER_REVISION(data_ptr) \
{                                                                           \
  ZB_ZCL_ATTR_SCENES_CLUSTER_REVISION,                                      \
  ZB_ZCL_ATTR_TYPE_U16,                                                     \
  ZB_ZCL_ATTR_ACCESS_READ_ONLY,                                             \
  (void*) data_ptr                                                          \
}
