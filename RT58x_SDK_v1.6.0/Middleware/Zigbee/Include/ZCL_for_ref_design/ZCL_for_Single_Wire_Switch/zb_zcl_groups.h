...
enum zb_zcl_groups_attr_e
{
    ...
    ZB_ZCL_ATTR_GROUPS_CLUSTER_REVISION = 0xFFFD
};
...
#define ZB_ZCL_DECLARE_GROUPS_ATTRIB_LIST_TJ(attr_list, name_support,cluster_revision)      \
  ZB_ZCL_START_DECLARE_ATTRIB_LIST(attr_list)                           \
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_GROUPS_NAME_SUPPORT_ID, (name_support)) \
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_GROUPS_CLUSTER_REVISION, (cluster_revision)) \
  ZB_ZCL_FINISH_DECLARE_ATTRIB_LIST
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_GROUPS_CLUSTER_REVISION(data_ptr)  \
{                                                                 \
  ZB_ZCL_ATTR_GROUPS_CLUSTER_REVISION,                             \
