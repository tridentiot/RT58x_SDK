...
enum zb_zcl_level_control_attr_e
{
    ...
    ZB_ZCL_ATTR_LEVEL_CONTROL_CLUSTER_REVISION            = 0xFFFD,
};
...
#define ZB_ZCL_DECLARE_LEVEL_CONTROL_ATTRIB_LIST_TJ(attr_list, current_level, remaining_time,cluster_revision)  \
  ZB_ZCL_START_DECLARE_ATTRIB_LIST(attr_list)                                               \
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_LEVEL_CONTROL_CURRENT_LEVEL_ID, (current_level))         \
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_LEVEL_CONTROL_REMAINING_TIME_ID, (remaining_time))       \
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_LEVEL_CONTROL_CLUSTER_REVISION, (cluster_revision))       \
  ZB_ZCL_FINISH_DECLARE_ATTRIB_LIST
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_LEVEL_CONTROL_CLUSTER_REVISION(data_ptr) \
{                                                                                  \
  ZB_ZCL_ATTR_LEVEL_CONTROL_CLUSTER_REVISION,                                      \
  ZB_ZCL_ATTR_TYPE_U16,                                                            \
  ZB_ZCL_ATTR_ACCESS_READ_ONLY,                                                    \
  (void*) data_ptr                                                                 \
}
