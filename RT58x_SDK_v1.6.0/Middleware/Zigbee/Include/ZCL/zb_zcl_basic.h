...
#define ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST_EXT(                                       \
  ...
  zb_bool_t device_enable_##attr_list = ZB_TRUE;                                    \
    ...
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_PHYSICAL_ENVIRONMENT_ID, (ph_env))       \
        ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_GENERIC_DEVICE_CLASS_ID, (device_class)) \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_GENERIC_DEVICE_TYPE_ID, (device_type))   \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_PRODUCT_CODE_ID, (product_code))         \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_PRODUCT_URL_ID, (product_url))\
        ZB_ZCL_FINISH_DECLARE_ATTRIB_LIST
