...
typedef enum
{
    ...
    APP_REQUEST_PRIVACY_ONOFF,           /**< Application request event: enable/disable privacy.*/
} app_request_t;
...
/** @brief Privacy state change.
 * @details Change privacy status to eanble or disable.
 *
 * @return none.
 */
