...
uint16_t g_attr_zone_type = ZB_ZCL_IAS_ZONE_ZONETYPE_MOTION;
uint16_t g_attr_zone_status = 0;
uint8_t g_attr_ias_cie_address[8] = {0, 0, 0, 0, 0, 0, 0, 0};
...
ZB_AF_SIMPLE_DESC_TYPE(5, 1) simple_desc_pir =
{
    2,                                              /* Endpoint */
    ZB_AF_HA_PROFILE_ID,                            /* Application profile identifier */
    HA_IAS_ZONE_ID,                                 /* Application device identifier */
...
ZB_AF_DECLARE_ENDPOINT_DESC(ias_ep,
                            2,
                            ZB_AF_HA_PROFILE_ID,
                            0,
                            NULL,
                            ...
                            (zb_af_simple_desc_1_1_t *)&simple_desc_pir,
                            8,
                            rep_ctx,
                            0,
                            NULL);

zb_af_endpoint_desc_t *ias_ep_list[] =
{
    &ias_ep,
};

zb_af_device_ctx_t simple_desc_pir_ctx =
{
    1,
    ias_ep_list
};
