...
enum zb_zcl_on_off_attr_e
{
    ...
    /*Add the cluster revision attribute for Tijio */
    ZB_ZCL_ATTR_ON_OFF_CLUSTER_REVISION     = 0xFFFD,
};
...
#define ZB_ZCL_DECLARE_ON_OFF_ATTRIB_LIST_EXT_TJ(                                               \
    attr_list, on_off, global_scene_ctrl, on_time, off_wait_time,cluster_revision               \
    )                                                                                           \
    ZB_ZCL_START_DECLARE_ATTRIB_LIST(attr_list)                                                 \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_ON_OFF_ON_OFF_ID, (on_off))                                \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_ON_OFF_GLOBAL_SCENE_CONTROL, (global_scene_ctrl))          \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_ON_OFF_ON_TIME, (on_time))                                 \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_ON_OFF_OFF_WAIT_TIME, (off_wait_time))                     \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_ON_OFF_CLUSTER_REVISION, (cluster_revision))               \
    ZB_ZCL_FINISH_DECLARE_ATTRIB_LIST
...
enum zb_zcl_on_off_cmd_e
{
    ...
    ZB_ZCL_CMD_ON_OFF_ON_WITH_TIMED_OFF_ID_PRIVATE   = 0x43, /**< "On with timed off" command. */
};
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_ON_OFF_CLUSTER_REVISION(data_ptr)\
{                                                                       \
  ZB_ZCL_ATTR_ON_OFF_CLUSTER_REVISION,                                  \
  ZB_ZCL_ATTR_TYPE_U16,                                                 \
  ZB_ZCL_ATTR_ACCESS_READ_ONLY,                                         \
  (void*) data_ptr                                                      \
}
