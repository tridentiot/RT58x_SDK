...
enum zb_zcl_identify_attr_e
{
    ...
    ZB_ZCL_ATTR_IDENTIFY_IDENTIFY_CLUSTER_REVISION = 0xFFFD
};
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_IDENTIFY_IDENTIFY_CLUSTER_REVISION(data_ptr)  \
{                                                               \
  ZB_ZCL_ATTR_IDENTIFY_IDENTIFY_CLUSTER_REVISION,               \
  ZB_ZCL_ATTR_TYPE_U16,                                         \
...
#define ZB_ZCL_DECLARE_IDENTIFY_ATTRIB_LIST_TJ(attr_list, identify_time,cluster_revision)   \
  ZB_ZCL_START_DECLARE_ATTRIB_LIST(attr_list)                           \
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_IDENTIFY_IDENTIFY_TIME_ID, (identify_time)) \
  ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_IDENTIFY_IDENTIFY_CLUSTER_REVISION, (cluster_revision)) \
  ZB_ZCL_FINISH_DECLARE_ATTRIB_LIST
