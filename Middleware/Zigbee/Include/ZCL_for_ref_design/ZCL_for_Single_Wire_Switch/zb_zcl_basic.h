...
enum zb_zcl_basic_info_attr_e
{
    ...
    ZB_ZCL_ATTR_BASIC_CLUSTER_REVISION                = 0xFFFD
};
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_BASIC_GENERIC_DEVICE_CLASS_ID(data_ptr) \
{                                                                          \
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_BASIC_GENERIC_DEVICE_TYPE_ID(data_ptr) \
{                                                                          \
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_BASIC_PRODUCT_CODE_ID(data_ptr) \
{                                                                          \
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_BASIC_PRODUCT_URL_ID(data_ptr) \
{                                                                         \
...
#define ZB_SET_ATTR_DESCR_WITH_ZB_ZCL_ATTR_BASIC_CLUSTER_REVISION(data_ptr) \
{                                                                         \
  ZB_ZCL_ATTR_BASIC_CLUSTER_REVISION,                                       \
...
#define ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST_EXT_TJ(                                    \
  attr_list,                                                                        \
  zcl_version,                                                                      \
  app_version,                                                                      \
  stack_version,                                                                    \
  ...
  cluster_revision)                                                                 \
    ...
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_MODEL_IDENTIFIER_ID, (model_id))         \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_POWER_SOURCE_ID, (power_source))         \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_GENERIC_DEVICE_CLASS_ID, (class_id))     \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_GENERIC_DEVICE_TYPE_ID, (type_id))       \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_PRODUCT_CODE_ID, (code_id))              \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_PRODUCT_URL_ID, (url_id))                \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_SW_BUILD_ID, (sw_build_id))              \
    ZB_ZCL_SET_ATTR_DESC(ZB_ZCL_ATTR_BASIC_CLUSTER_REVISION, (cluster_revision))    \
    ZB_ZCL_FINISH_DECLARE_ATTRIB_LIST

#define ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST_EXT_WC(                                       \
  attr_list,                                                                        \
  zcl_version,                                                                      \
  app_version,                                                                      \
  stack_version,                                                                    \
...
#define ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST_EXT_TJ_WC(                                    \
  attr_list,                                                                        \
  zcl_version,                                                                      \
  app_version,                                                                      \
  stack_version,                                                                    \
...
#define ZB_ZCL_DECLARE_BASIC_ATTRIB_LIST_DOORSCENCE(                                \
  attr_list,                                                                        \
  zcl_version,                                                                      \
  app_version,                                                                      \
  stack_version,                                                                    \
